...
// 	protoc        (unknown)
// source: models/v1/positions.proto
...
func (x *Position) Reset() {
	*x = Position{}
	if protoimpl.UnsafeEnabled {
		mi := &file_models_v1_positions_proto_msgTypes[0]
...
var File_models_v1_positions_proto protoreflect.FileDescriptor
...
var (
	file_models_v1_positions_proto_rawDescOnce sync.Once
	file_models_v1_positions_proto_rawDescData = file_models_v1_positions_proto_rawDesc
)

func file_models_v1_positions_proto_rawDescGZIP() []byte {
	file_models_v1_positions_proto_rawDescOnce.Do(func() {
		file_models_v1_positions_proto_rawDescData = protoimpl.X.CompressGZIP(file_models_v1_positions_proto_rawDescData)
	})
...
func init() { file_models_v1_positions_proto_init() }
func file_models_v1_positions_proto_init() {
	if File_models_v1_positions_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_models_v1_positions_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_models_v1_positions_proto_goTypes,
		DependencyIndexes: file_models_v1_positions_proto_depIdxs,
		MessageInfos:      file_models_v1_positions_proto_msgTypes,
	}.Build()
	File_models_v1_positions_proto = out.File
	file_models_v1_positions_proto_rawDesc = nil
	file_models_v1_positions_proto_goTypes = nil
	file_models_v1_positions_proto_depIdxs = nil
}
